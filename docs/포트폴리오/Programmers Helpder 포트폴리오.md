...
<a href="{{ '/포트폴리오/Programmers Helper 실제사용화면1.png' | relative_url }}" data-lightbox>
  <img src="{{ '/포트폴리오/Programmers Helper 실제사용화면1.png' | relative_url }}" alt="Programmers Helper Overview" width="60%" style="max-height: 80vh; height: auto;" />
</a>
